<div>
    <div class="mx-auto max-w-7xl p-4 md:p-6">
        <!-- Breadcrumb Start -->
        <div x-data="{ pageName: `Settings` }" class="mb-6">
                ...
                <div class="border-t border-gray-100 p-6 dark:border-gray-800 xl:p-10">
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                        <a href="{{ route('admin.settings.general') }}"
                            class="px-2 py-3 flex flex-col justify-center items-center gap-3 border border-gray-200 rounded-md shadow-sm hover:shadow-md">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="size-10">
